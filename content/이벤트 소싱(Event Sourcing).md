...
이벤트 소싱은 자연스럽게 도메인 이벤트(Domain Events)를 활용하므로, [[도메인 주도 설계(DDD,Domain Driven Design)]]와 잘 어울립니다.
...
이벤트 소싱은 [[이벤트 기반 아키텍처(Event-Driven Architecture)]]의 한 형태로 볼 수 있으며, 시스템 컴포넌트 간의 느슨한 결합을 제공합니다.

### 마이크로서비스 아키텍처(Microservices Architecture)

이벤트 소싱은 [[마이크로서비스 아키텍처(Microservice Architecture)]]에서 서비스 간 데이터 일관성 유지와 통신에 유용하게 활용될 수 있습니다.
