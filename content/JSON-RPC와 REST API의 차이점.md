JSON-RPC와 [[REST API]]는 현대적인 웹 서비스와 애플리케이션에서 널리 사용되는 두 가지 주요 통신 방식입니다. 두 기술 모두 [[JSON (JavaScript Object Notation)]]과 HTTP를 기반으로 동작할 수 있어 종종 혼동되지만, 그 기반 철학과 구조, 사용 목적에는 명확한 차이가 존재합니다.
