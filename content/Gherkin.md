**Gherkin**은 [[Cucumber]]에서 사용하는 **비즈니스 가독성 있는, 도메인 특화 언어(Business Readable, Domain Specific Language, BRDSL)**입니다. 복잡한 프로그래밍 구문 대신, 정해진 키워드와 자연어를 사용하여 시스템의 행위(Behavior)를 명확하고 구조적으로 기술할 수 있도록 설계되었습니다.
