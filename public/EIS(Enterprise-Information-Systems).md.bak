엔터프라이즈 정보 시스템(EIS)은 기업의 비즈니스 프로세스를 통합하여 기능을 향상시키는 모든 종류의 정보 시스템을 말합니다. 고품질의 서비스를 제공하고 대용량 데이터를 처리하며, 대규모 또는 복잡한 조직을 지원할 수 있는 능력을 가져야 합니다. EIS는 기업의 모든 부서와 모든 수준에서 사용될 수 있어야 합니다.
## 목적
